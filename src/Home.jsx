...
tl12_animC.fromTo('.anim_12', {  right: "45%", top: "96%", opacity: 1, duration: 1, scale: 0.8, },
   ...
   //  .add(animOpenTLL, 5.0)
    ...
    useEffect(() => {
        ...
        ScrollTrigger.create({
            ...
            end: '+=2000',       // You can adjust the 'end' value as needed
            scrub: true,
            pin: true,
            anticipatePin: 1,
            pinSpacing: true,
 ...
 const LineRotateTLL = () => {             
    ...
    const createAnimation = (buttonId, animationConfig) => {
        const LineExpandTL = gsap.timeline({ paused: true });
    
        const timelines = animationConfig.map(config => {
            const tl = gsap.timeline();
            tl.fromTo(config.target, config.from, config.to);
            return tl;
        });
    
        LineExpandTL.add(timelines, 0.5);
        LineExpandTL.fromTo('.background', { opacity: 0 }, { opacity: 1, duration: 1 });
    
        const timeline = LineExpandTL;
        const resetTimeline = () => {
            timeline.pause(0);
        };
        ...
        if (button) {
            button.addEventListener('click', () => {
                ...
                // Set the clicked button to scale 1.5
                gsap.to(button, { scale: 1.5 });
                ...
                setTimeout(() => {
                        // Reverse animation to scale back to 1
    ...
    const buttons = [
        { id: 'devButton', config: [
            { target: '.line_1', from: { scale: 1.5 ,duration: 0.1, opacity:0   }, to: { opacity:1,  scale: 0.4, duration: 0.5,ease: "bounce.out"  } },
            { target: '.line_2', from: { scale: 1.4,duration: 0.1,  }, to: { scale: 0.4, duration: 0.5,ease: "bounce.out"  } },
            { target: '.line_3', from: { scale: 1.3,duration: 0.1, }, to: { scale: 0.4, duration: 0.5 ,ease: "bounce.out" } },
            { target: '.line_4', from: { scale: 1.2,duration: 0.1,  }, to: {  scale: 0.4, duration: 0.5 ,ease: "bounce.out" } },
            { target: '.line_4', from: { scale: 0.5, duration: 2 }, to: { scale: 1.1, duration: 2.5, ease: "bounce.out" } }
        ] },
        { id: 'digiButton', config: [
                { target: '.line_1', from: { scale:0.5  }, to: { scale: 0.4, duration: 0.5 } },
                { target: '.line_2', from: { scale:0.5  }, to: { scale: 0.4, duration: 0.6 } },
                { target: '.line_3', from: { scale:0.5  }, to: { scale: 0.4, duration: 0.7 } },
                { target: '.line_4', from: { scale:0.5 }, to: { scale: 0.4, duration: 0.8 } },
                { target: '.line_1', from: { scale: 0.5, duration: 2 }, to: { scale: 0.8, duration: 2.5, ease: "bounce.out" } }
        ] },
        { id: 'brandingButton', config: [
                { target: '.line_1', from: { scale: 0.5}, to: { scale: 0.4, duration: 1 } },
                { target: '.line_2', from: { scale: 0.5}, to: { scale: 0.4, duration: 1 } },
                { target: '.line_3', from: { scale: 0.5 }, to: { scale: 0.4, duration: 1 } },
                { target: '.line_4', from: { scale: 0.5 }, to: { scale: 0.4, duration: 1 } },
                { target: '.line_3', from: { scale: 0.5, duration: 2 }, to: { scale: 1.1, duration: 2.5, ease: "bounce.out" } }
        ] },
        { id: 'animButton', config: [
                { target: '.line_1', from: { scale: 0.5 }, to: { scale: 0.4, duration: 1 } },
                { target: '.line_2', from: { scale: 0.5}, to: { scale: 0.4, duration: 1 } },
                { target: '.line_3', from: { scale: 0.5}, to: { scale: 0.4, duration: 1 } },
                { target: '.line_4', from: { scale: 0.5}, to: { scale: 0.4, duration: 1 } },
                { target: '.line_2', from: { scale: 0.5, duration: 2 }, to: { scale: 1, duration: 2.5, ease: "bounce.out" } },
    ...
    const animations = buttons.map(button => createAnimation(button.id, button.config));
                        ...
                        <div className="mainBg">
                            <div className="container mx-auto">
                                <div className="heroText" data-speed="1.8" >
                                    ...
                                    <div className="introText" data-speed="0.9">
