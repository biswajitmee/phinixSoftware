...
function MainSection() {
    ...
    const devOpenTLL = () => {             
        const devOpenTL = gsap.timeline({ paused: true });
 ...
 tl1_devO.fromTo('.dev_1', {  left: "45%", top: "-4%", opacity: 1, duration: 0.5, scale: 0, },
            { delay: 0.5, opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.7)" });

  tl2_devO.fromTo('.dev_2', {  left: "18%", top: "4%", opacity: 1, duration: 1, scale: 0, },
            { delay: 0.55, opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.7)" });

  tl3_devO.fromTo('.dev_3', { delay: 1, left: "2%", top: "21%", opacity: 1, duration: 0.5, scale: 0, },
            { delay: 0.60, opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.7)" });

  tl4_devO.fromTo('.dev_4', {  left: "-4%", top: "45%", opacity: 1, duration: 1, scale: 0, },
            { delay: 0.65, opacity: 1, duration: 1, scale: 0.8,  ease: "elastic.inOut(1, 0.3)" });

  tl5_devO.fromTo('.dev_5', {  left: "0%", top: "68%", opacity: 1, duration: 0.5, scale: 0, },
            { delay: 0.70, opacity: 1, duration: 1, scale: 0.8,  ease: "elastic.inOut(1, 0.3)" });

 tl6_devO.fromTo('.dev_6', {  left: "16%", top: "85%", opacity: 1, duration: 1, scale: 0, },
            { delay: 0.75, opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.3)" });
                             

tl7_devO.fromTo('.dev_8', {  right: "45%", top: "96%", opacity: 1, duration: 1, scale: 0, },
            { delay: 0.80, opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.3)" });

tl8_devO.fromTo('.dev_12', {  right: "16%", top: "85%", opacity: 1, duration: 1, scale: 0, },
            { delay: 0.85, opacity: 1, duration: 1, scale: 0.8,  ease: "elastic.inOut(1, 0.3)" }); 
       
tl9_devO.fromTo('.dev_11', {  right: "0%", top: "68%", opacity: 1, duration: 0.5, scale: 0, },
            { delay: 0.90, opacity: 1, duration: 1, scale: 0.8,  ease: "elastic.inOut(1, 0.3)" });
    
tl10_devO.fromTo('.dev_10', {  right: "-4%", top: "45%", opacity: 1, duration: 1, scale: 0, },
            { delay: 0.95, opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.3)" });    

tl11_devO.fromTo('.dev_9', {  right: "2%", top: "21%", opacity: 1, duration: 0.5, scale: 0, },
            { delay: 1.0, opacity: 1, duration: 1, scale: 0.8,  ease: "elastic.inOut(1, 0.3)" });    

tl12_devO.fromTo('.dev_7', {  right: "18%", top: "4%", opacity: 1, duration: 0.5, scale: 0, },
            { delay: 1.20, opacity: 1, duration: 0.5, scale: 0.8,  ease: "elastic.inOut(1, 0.3)" });
   ...
   devOpenTL.add(tl1_devO, 0.5)
            ...
            const playDevOpenTimeline = () => {
                devOpenTL.play();
            };
            return playDevOpenTimeline;

          //  return devOpenTLL;

    }
    const playDevOpenTimeline = devOpenTLL();
 ...
 tl1_markO.fromTo('.mark_1', {  left: "10%", top: "11%", opacity: 1, duration: 0.5, scale: 0, },
            { opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.7)" });
 ...
 tl4_markO.fromTo('.mark_4', {  left: "6%", top: "75%", opacity: 1, duration: 1, scale: 0, },
            {   opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.3)" });
...
tl6_markO.fromTo('.mark_6', {  right: "10%", top: "11%", opacity: 1, duration: 0.5, scale: 0, },
            {   opacity: 1, duration: 0.5, scale: 0.8,  ease: "elastic.inOut(1, 0.3)" });
...
tl12_devC.fromTo('.dev_7', {  right: "18%", top: "4%", opacity: 1, duration: 0.5, scale: 0.8, },
    ...
    const marketingCloseLL = () => { 
        ...
        const marketingCloseL = gsap.timeline();
...
marketingCloseL.add(tl1_markC, 10)
            .add(tl2_markC, 1.15)
            .add(tl3_markC, 1.20)
            .add(tl4_markC, 1.25)
            .add(tl5_markC, 1.30)
...
tl1_brndC.fromTo('.brand_1', {  left: "10%", top: "11%", opacity: 1, duration: 0.5, scale: 0, },
        {   opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.7)" });
tl2_brndC.fromTo('.brand_2', {  left: "-2%", top: "33%", opacity: 1, duration: 1, scale: 0, },
        {   opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.7)" });
tl3_brndC.fromTo('.brand_3', { delay: 1, left: "-3%", top: "56%", opacity: 1, duration: 0.5, scale: 0, },
        {   opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.7)" });
tl4_brndC.fromTo('.brand_4', {  left: "6%", top: "75%", opacity: 1, duration: 1, scale: 0, },
        {   opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.3)" });         
tl5_brndC.fromTo('.brand_5', {  left: "25%", top: "90%", opacity: 1, duration: 1, scale: 0, },
         {  opacity: 1, duration: 1, scale: 0.8, ease: "elastic.inOut(1, 0.3)" }); 
...
tl10_brndC.fromTo('.brand_10', {  right: "25%", top: "90%", opacity: 1, duration: 1, scale: 0.8, },
        ...
        brandCloseTL.add(tl1_brndC, 2.10)
                    .add(tl2_brndC, 2.15)
                    .add(tl3_brndC, 2.20)
                    .add(tl4_brndC, 2.25)
                    .add(tl5_brndC, 2.30)
...
tl12_animC.fromTo('.anim_12', {  right: "45%", top: "96%", opacity: 1, duration: 1, scale: 0.8, },
    ...
    useEffect(() => {
        ...
        // masterCloseMergeTL.add(devCloseTLL, 1)        
        // .add(marketingCloseLL,1)
        //  .add(brandCloseTLL, 1)
        //  .add(animCloseTLL, 1)
        ...
        masterOpenMergeTL.add(playDevOpenTimeline, 0)        
         .add(marketingOpenTLL,0)
          .add(brandOpenTLL, 0)
          .add(animOpenTLL,0)
        ...
        ScrollTrigger.create({
            ...
            scrub:true,
          //  animation: masterCloseMergeTL,        // Your master timeline animation
        ...
        // tl1000.fromTo('.coverLine',
        // {  scale: 0,  ease: "elastic.Out(1, 0.9)"  },
        //  { width: "100vh", height: "100vh", scale: 1.1, duration: 1, ease: "elastic.Out(1, 0.9)" });



        tl1011.to('.line_1', { scale: 1.5, duration: 1, ease: "elastic.Out(1, 0.9)" });
        tl1022.to('.line_2', { scale: 1.4, duration: 1, ease: "elastic.Out(1, 0.9)" });
        tl1033.to('.line_3', { scale: 1.3, duration: 1, ease: "elastic.Out(1, 0.9)" });
        tl1044.to('.line_4', { scale: 1.2, duration: 1, ease: "elastic.Out(1, 0.9)" });
